...
class Strategy6 extends AbstractStrategy implements StrategyInterface
{
	...
	public function composeString()
	{
		...
		$methodString .= "\t\t\t\$singleEntity->addTo" . ucwords($this->inverse) . "(\$this);\n";
		$methodString .= "\t\t}\n";
		...
		$methodString .= "\t\t\t\$singleEntity->removeFrom" . ucwords($this->inverse) . "(\$this);\n";
		$methodString .= "\t\t}\n";
		$methodString .= "\t\treturn \$this;\n";
		$methodString .= "\t}\n\n";
