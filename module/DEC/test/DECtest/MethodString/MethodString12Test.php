...
use DEC\MethodString\MethodString12;

class MethodString12Test extends \PHPUnit_Framework_TestCase {

    public function testMethodString12getStringFromStrategyOutput()
    {
        ...
        $property->setAssociation(12);
        $methodString12 = new MethodString12($property);
        $resultingMethodString = $methodString12->getStringFromStrategy();
